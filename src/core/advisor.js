...
export function portfolioFacts(portfolio) {
  ...
  return {
    ...
    netPnlAllTimeUsd: summary?.allTime?.lpVsHodlUsd != null ? summary.allTime.netPnlUsd : null,
    vsHoldingAllTimeUsd: summary?.allTime?.lpVsHodlUsd ?? null,
    headline: summary?.headline ?? null,
    historyHeadline: summary?.historyHeadline ?? null,
